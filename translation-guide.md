...
###README
README.md是整个文档的目录索引。另外，[打开看下](https://github.com/yii2-chinesization/yii2-zh-cn/blob/master/guide/zh-CN/README.md),你会发现，在每个条目的的前方会有一个标签，而后方则有着一些日期。他们是做神马的呢？
...
- 【已校对】校对完毕，且文章基本实现“信达萌”，则更新为该状态。文档需要更新时改为【需更新】
...
####原文的版本日期####
没有原文的版本日期，怎么知道该文章需不需要更新呢。所以需要加入文档的原文日期。
